								...
								if(result.data){
									...
									$.each(result.data, function(index, val) {
										...
										var item=[
												...
												'<button type="button" class="btn btn-sm btn-primary mr-1" data-toggle="modal" data-target=".banner-details-modal" data-modal-title="'+METLANG.editor+'" data-modal-size="xl" data-modal-url="'+edit_dataurl+val.id+'" data-modal-fullheight="1" data-modal-height100="1" data-modal-tablerefresh="'+table_order+'">'+METLANG.editor+'</button>'
