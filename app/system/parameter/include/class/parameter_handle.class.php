...
class parameter_handle extends handle
{
     ...
     * @return array
     */
    public function para_handle_formation($para = array(), $simplify = true,$module='',$id='')
    {
        global $_M;
                                ...
                                $val['type_html'] .= "
 								<div class=\"checkbox-custom checkbox-primary\">
 									<input
 										...
 										type=\"checkbox\"
 										value=\"{$pv['value']}\"
 										id=\"para{$val['id']}_{$i}_{$id}\"
 										{$product_selected}
 										{$pv['required']}
 										data-delimiter=',';
 									>
 									<label for=\"para{$val['id']}_{$i}_{$id}\">{$pv['value']}</label>
 								</div>";
                            } else {
                                $val['type_html'] .= "
 								<div class=\"checkbox-custom checkbox-primary\">
 									<input
 										...
 										id=\"para{$val['id']}_{$i}_{$id}\"
 									>
 									<label for=\"para{$val['id']}_{$i}_{$id}\">{$pv}</label>
 								</div>";
                            }
