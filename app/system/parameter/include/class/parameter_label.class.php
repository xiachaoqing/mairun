...
class parameter_label
{
    ...
    public function get_para($module, $class1, $class2, $class3)
    {
        $mod = is_numeric($module) ? $module : $this->name_to_num($module);
        return load::mod_class('parameter/parameter_database', 'new')->get_parameter($mod, $class1, $class2, $class3);
    }
     ...
     * @return array
     */
    public function get_parameter_form($module = '', $class1 = '', $class2 = '', $class3 = '',$id='')
    {
        global $_M;
        ...
        $paras = load::mod_class('parameter/parameter_handle', 'new')->para_handle_formation($parameter_list,true,$module,$id?$id:$class1);
        return $paras;
    }
