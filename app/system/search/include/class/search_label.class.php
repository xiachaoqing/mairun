...
//                $order_url .= "&content={$_M['form']['content']}";
            ...
            $class1 = isset($class123['class1']['id']) ? $class123['class1']['id'] : 0;
            $class2 = isset($class123['class2']['id']) ? $class123['class2']['id'] : 0;
            $class3 = isset($class123['class3']['id']) ? $class123['class3']['id'] : 0;
            $paras = load::sys_class('label', 'new')->get('parameter')->get_para($class123['class1']['module'], $class1, $class2, $class3);
