			...
			<div class="col-lg-9">
				<div class="panel panel-default m-b-0">
					<div class='panel-body met-member-index met-member-profile'>
					  	<div class="panel-heading p-x-15 clearfix">
							<div class="p-y-10 pull-xs-left">{$_M['word']['memberIndex9']}</div>
							<a href="{$url.login_out}" class='btn btn-danger btn-outline btn-sm m-t-5 pull-xs-right'><i class="icon wb-power"></i> {$word.memberIndex10}</a>
						</div>
					  	<div class="basic">
							<div class="row">
