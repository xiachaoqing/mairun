...
<main>
    ...
    <div class="met-index-product met-index-body text-xs-center" m-id="met_index_product">
        <div class="container">
            ...
            <?php } ?>
                ...
                <p class="desc m-b-0 invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><?php echo $lang['index_product_desc'];?></p>
            <?php } ?>
            <!-- 切换卡 -->
    ...
    foreach($result as $index=>$m):
        ...
        $result[$index] = $m;
?>
                        <?php if($m['_index']<$lang['index_product_allnum']){ ?>
                        <li class="nav-item mr-2">
                            <a class='nav-link btn rounded-pill     <?php if($m['_index']==0){ ?>active
                    <?php } ?>'
                    data-toggle="tab" href="#list-type-tab-pane-<?php echo $m['_index'];?>">
                    <?php echo $m['name'];?>
                    </a>
                    </li>
                    <?php } ?>
...
?>
                        <?php if($m['_index']<$lang['index_product_allnum']){ ?>
                        <div class='tab-pane     <?php if($m['_index']==0){ ?>active
                    <?php } ?>' id="list-type-tab-pane-<?php echo $m['_index'];?>">
                    <div class="leftbox">
                        <a href="<?php echo $m['url'];?>" title="<?php echo $m['name'];?>" class="block" <?php echo $g['urlnew'];?>>
                            <img class="" src="<?php echo thumb($m['columnimg'],$lang['index_product_img_w'],$lang['index_product_img_h']);?>" alt="<?php echo $v['title'];?>">
                        </a>
                    </div>
...
?>
                            <div class="itembox">
                                ...
                                <div class="">
                                    <img class="" src="<?php echo thumb($v['imgurl'],$lang['index_product_img_w1'],$lang['index_product_img_h1']);?>" alt="<?php echo $v['title'];?>">
                                </div>

                                <a met-imgmask href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" class="txt-info" <?php echo $g['urlnew'];?>>
                                    <h4 class="card-title m-0 p-x-10 text-shadow-none text-truncate">
                                        <?php echo $v['title'];?>
                                    </h4>
                                        <?php if($lang['index_product_moretext']){ ?>
                                        <p class="m-b-0 moretext"><?php echo $lang['index_product_moretext'];?></p>
                                    <?php } ?>
                                </a>
    ...
    <div class="met-index-about met-index-body text-xs-center" m-id="met_index_about" m-type="nocontent">
        <div class="container">
                <?php if($lang['home_about_title']){ ?>
                <h2 class="m-t-0 invisible" data-plugin="appear" data-animate="slide-top" data-repeat="false"><?php echo $lang['home_about_title'];?></h2>
            <?php } ?>
                <?php if($lang['home_about_desc']){ ?>
                <p class="desc m-b-0 invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><?php echo $lang['home_about_desc'];?></p>
            <?php } ?>
            <div class="row">
                <div class="text met-editor">
                    <?php echo $lang['home_about_content'];?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="met-index-case met-index-body text-xs-center" m-id="met_index_case">
        <div class="container">
                <?php if($lang['home_case_title']){ ?>
                <h2 class="m-t-0 invisible" data-plugin="appear" data-animate="slide-top" data-repeat="false"><?php echo $lang['home_case_title'];?></h2>
            <?php } ?>
                <?php if($lang['home_case_desc']){ ?>
                <p class="desc m-b-0 invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><?php echo $lang['home_case_desc'];?></p>
            <?php } ?>
            <div class="swiper-container">
                <ul class=" swiper-wrapper">
                    <?php
    $cid=$lang['home_case_id'];
    $num = $lang['home_case_num'];
    $module = "";
    $type = $lang['home_case_type'];
    $order = 'no_order asc';
    $para = "0";
    if(!$module){
        if(!$cid){
...
?>
                            ...
                            <?php if($lang['home_case_num']){ ?>
                        <li class="swiper-slide">
                                <?php if($lang['home_case_linkok']){ ?>
                                <a href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?>>
                            <?php } ?>
                            <img src="<?php echo thumb($v['imgurl'],$lang['home_case_imgw'],$lang['home_case_imgh']);?>" alt="<?php echo $v['title'];?>" style="max-width: 100%;" />
                                <?php if($lang['home_case_linkok']){ ?>
                                </a>
                            <?php } ?>

                            <a     <?php if($lang['home_case_linkok']){ ?>href="<?php echo $v['url'];?>" <?php echo $g['urlnew'];?>
                                <?php }else{ ?>
                                href="javascript:void(0)"<?php } ?> title="<?php echo $v['title'];?>" class="a_box">
                                <h4 class="contenttitle"><?php echo $v['title'];?></h4>
                            </a>
    ...
    <div class="met-index-news met-index-body text-xs-center" m-id="met_index_news">
        <div class="container">
            ...
            <?php } ?>
                ...
                <p class="desc m-b-0 invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><?php echo $lang['index_news_desc'];?></p>
            <?php } ?>

                <?php if($lang['index_news_mytype']){ ?>
                <!-- 无图风格 -->
...
?>
                                ...
                                <li class="invisible" data-plugin="appear" data-animate="slide-bottom" data-repeat="false">
                                    <a class="media media-lg flex" href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?>>
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading m-b-10"><?php echo $v['title'];?></h4>
                                            <p class="info m-b-8">
                                                <span><?php echo $v['updatetime'];?></span>
                                            </p>
                                            <p class="des m-b-5"><?php echo met_substr($v['description'],0,$lang['home_news_img_maxnum']);?>...</p>
                                        </div>
                                    </a>
                                </li>
                            <?php endforeach;?>
...
?>
                                <?php if($v['_index']==0){ ?>
                                <a class="itembox" href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?>>
                                    <div class="imgbox">
                                        <img class="" src="<?php echo thumb($v['imgurl'],$lang['home_product_img_w1'],$lang['home_product_img_h1']);?>" alt="<?php echo $v['title'];?>">
                                    </div>
                                    <div class="textbox">
                                        <h4 class=""><?php echo $v['title'];?></h4>
                                    </div>
                                </a>
...
?>
                                <?php if($v['_index']<>0){ ?>
                                <a class="media media-lg" href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?>>
                                    <div class="imgbox col-md-4">
                                        <img class="" src="<?php echo thumb($v['imgurl'],$lang['home_product_img_w'],$lang['home_product_img_h']);?>" alt="<?php echo $v['title'];?>">
                                    </div>

                                    <div class="col-md-8">
                                        <h4 class=" m-b-10"> <?php echo $v['title'];?> </h4>
                                        <p class="info">
                                            <span><?php echo $v['updatetime'];?></span>
                                        </p>
                                        <p class="des m-b-5"><?php echo met_substr($v['description'],0,$lang['home_news_img_maxnum']);?>...</p>
