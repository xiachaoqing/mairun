    ...
    <div class="met-showproduct-head page-content block-bg">
        <div class="container">
            ...
            foreach ($data['displayimgs'] as $index => $val) {
                ...
                $s = $val;
            ?><?php }?>
                    <div class='met-showproduct-list fngallery cover text-xs-center    <?php if($s['_index']>0){ ?>slick-dotted<?php } ?>' id='met-imgs-slick' m-id='noset' m-type='displayimgs'>
            ...
            ?>
                        <div class='slick-slide'>
                            <a href='<?php echo $s['img'];?>' data-size='<?php echo $s['x'];?>x<?php echo $s['y'];?>' data-med='<?php echo $s['img'];?>' data-med-size='<?php echo $s['x'];?>x<?php echo $s['y'];?>' class='lg-item-box' data-src='<?php echo $s['img'];?>' data-exthumbimage="<?php echo thumb($s['img'],60,60,0,0);?>" data-sub-html='<?php echo $s['title'];?>'>
            ...
            ?>
                                <?php if($s['value']){ ?>
                            <a href="<?php echo $s['value'];?>" class="btn btn-danger m-r-20" target="_blank"><?php echo $s['name'];?></a>
                            <?php } ?>
                            <?php }?>
                        </div>
                        <?php } ?>
    ...
    <div class="met-showproduct-body page-content">
        <div class="container">
            ...
            foreach ($data['taglist'] as $index => $val) {
                ...
                $tag = $val;
            ?>
                                        <a href="<?php echo $tag['url'];?>" <?php echo $g['urlnew'];?> title="<?php echo $tag['name'];?>"><?php echo $tag['name'];?></a>
                                    <?php }?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <aside class="panel panel-body m-b-0 product-hot met-sidebar leftsidebar" boxmh-h m-id='product_bar' m-type='nocontent'>
                                <div class='sidebar-piclist'>
                                    <h3 class='m-0 font-size-16 font-weight-300'><?php echo $lang['product_sidebar_piclist_title'];?></h3>
                                    <ul class='blocks-2 blocks-md-3 blocks-lg-100 m-t-20 text-xs-center imagesize sidebar-piclist-ul' data-scale='<?php echo $c['met_productimg_y'];?>x<?php echo $c['met_productimg_x'];?>'>
                                        <?php if($lang['product_sidebar_content']){ ?>
                                        <?php
    $cid=$data['class1'];
    $num = $lang['product_sidebar_piclist_num'];
    $module = "";
    $type = $lang['product_sidebar_piclist_type'];
    $order = 'no_order asc';
    $para = "0";
    if(!$module){
        if(!$cid){
...
?>
                                        <li class='masonry-child'>
                                            <a href='<?php echo $v['url'];?>' title='<?php echo $v['title'];?>' class='block m-b-0' <?php echo $g['urlnew'];?>>
                                                <img data-original="<?php echo thumb($v['imgurl'],$c['met_productdetail_x'],$c['met_productdetail_y']);?>" class='cover-image' alt='<?php echo $v['title'];?>' height='100'></a>
                                            <h4 class='m-t-10 m-b-0 font-size-14'>
                                                <a href='<?php echo $v['url'];?>' title='<?php echo $v['title'];?>' <?php echo $g['urlnew'];?>>    <?php if($v['_title']){ ?><?php echo $v['_title'];?><?php }else{ ?><?php echo $v['title'];?><?php } ?></a>
                                            </h4>
                                        </li>
                                        <?php endforeach;?>
                                    <?php }else{ ?>
                                                <?php
            $sub = is_array($data['tag_relations']) ? count($data['tag_relations']) : 0;
            $cycleindex = 50;
            
            if(!is_array($data['tag_relations']) && $data['tag_relations']){
                $data['tag_relations'] = explode('|',$data['tag_relations']);
            }

            foreach ($data['tag_relations'] as $index => $val) {
                if(is_numeric($index) && $index >= $cycleindex){
                    break;
                }
            ...
            ?>
                                            <li class='masonry-child'>
                                                <a href='<?php echo $v['url'];?>' title='<?php echo $v['title'];?>' class='block m-b-0' <?php echo $g['urlnew'];?>>
                                                    <img data-original="<?php echo thumb($v['imgurl'],$c['met_productdetail_x'],$c['met_productdetail_y']);?>" class='cover-image' alt='<?php echo $v['title'];?>' />
                                                </a>
                ...
                <div class="hot_box">
                    <h3><?php echo $lang['product_hottitle'];?></h3>
                    <div class="row">
                         <?php
    $relation_id = 0;
    $relation_module = 0;
...
?>
                                     <?php
            $sub = is_array($relation['list']) ? count($relation['list']) : 0;
            $cycleindex = 50;
            
            if(!is_array($relation['list']) && $relation['list']){
                $relation['list'] = explode('|',$relation['list']);
            }

            foreach ($relation['list'] as $index => $val) {
                if(is_numeric($index) && $index >= $cycleindex){
                    break;
                }
            ...
            ?>
                                 <div class="hot_itembox col-md-3 col-sm-6 col-xs-6">
                                     <a href='<?php echo $val['url'];?>' title='<?php echo $val['title'];?>' <?php echo $g['urlnew'];?>>
                                             <?php if($relation['relation_module']<>4){ ?>
                                         <img src="<?php echo $val['imgurl'];?>" alt="<?php echo $val['title'];?>" style="width:100%; height:auto;">
                                         <?php } ?>
                                         <h4 class="hot_itemboxtitle" style="text-align: center;"><?php echo $val['_title'];?></h4>
                                     </a>
                                 </div>
                             <?php }?>
                         <?php endforeach;?>
