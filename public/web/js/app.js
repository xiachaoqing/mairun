...
M['plugin']['formvalidation']=[
    M['url']['public_plugins']+'formvalidation/formValidation.min.css',
    M['url']['public_plugins']+'formvalidation/formValidation.min.js',
...
M['plugin']['lazyload']=M['url']['public_plugins']+'jquery-lazyload/jquery.lazyload.min.js';
